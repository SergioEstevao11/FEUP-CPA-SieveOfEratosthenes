/*
 *  soetasks.cpp - implementation of the sieve of erastothenes 
                   w/ parallel lookups using OpenMP's tasks construct
 *  CPA @ M.EIC, 2023
 *  Authors:
...
main(void)
{
    ...
    #pragma omp taskloop num_tasks(12) private(sieve) reduction(+:computed)
